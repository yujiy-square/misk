...
object Dependencies {
  ...
  val grpcProtobuf = "io.grpc:grpc-protobuf:1.41.0"
  ...
  val hopliteHocon = "com.sksamuel.hoplite:hoplite-hocon:1.4.15"
  val hopliteJson = "com.sksamuel.hoplite:hoplite-json:1.4.15"
  val hopliteToml = "com.sksamuel.hoplite:hoplite-toml:1.4.15"
  val hopliteYaml = "com.sksamuel.hoplite:hoplite-yaml:1.4.15"
  ...
  val kotestAssertions = "io.kotest:kotest-assertions-core:4.6.2"
  val kotestJunitRunnerJvm = "io.kotest:kotest-runner-junit5-jvm:4.6.2"
  val kotestProperty = "io.kotest:kotest-property:4.6.2"
  val kotlinAllOpenPlugin = "org.jetbrains.kotlin:kotlin-allopen:1.5.31"
  val kotlinBinaryCompatibilityPlugin = "org.jetbrains.kotlinx:binary-compatibility-validator:0.6.0"
  val kotlinBom = "org.jetbrains.kotlin:kotlin-bom:1.5.31"
  val kotlinGradlePlugin = "org.jetbrains.kotlin:kotlin-gradle-plugin:1.5.31"
  val kotlinNoArgPlugin = "org.jetbrains.kotlin:kotlin-noarg:1.5.31"
  val kotlinReflection = "org.jetbrains.kotlin:kotlin-reflect:1.5.31"
  val kotlinRetry = "com.michael-bull.kotlin-retry:kotlin-retry:1.0.8"
  val kotlinStdLibJdk8 = "org.jetbrains.kotlin:kotlin-stdlib-jdk8:1.5.31"
  val kotlinTest = "org.jetbrains.kotlin:kotlin-test:1.5.31"
  ...
  val micrometerPrometheus = "io.micrometer:micrometer-registry-prometheus:1.7.2"
  ...
  val nettyBom = "io.netty:netty-bom:4.1.72.Final"
  ...
  val wireCompiler = "com.squareup.wire:wire-compiler:4.0.0-alpha.19"
  val wireGradlePlugin = "com.squareup.wire:wire-gradle-plugin:4.0.0-alpha.19"
  val wireGrpcClient = "com.squareup.wire:wire-grpc-client:4.0.0-alpha.19"
  val wireMoshiAdapter = "com.squareup.wire:wire-moshi-adapter:4.0.0-alpha.19"
  val wireReflector = "com.squareup.wire:wire-reflector:4.0.0-alpha.19"
  val wireRuntime = "com.squareup.wire:wire-runtime:4.0.0-alpha.19"
  val wireSchema = "com.squareup.wire:wire-schema:4.0.0-alpha.19"
